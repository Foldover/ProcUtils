...
func CreateMap():
	#ProcUtil.PerlinMap(heightMap, width, height, mouseP.x, mouseP.y, 2, 0.1, 0.1, zoom)
	#ProcUtil.NormalizeMap(heightMap, width, height)
	heightMap = ProcUtil.MapOne2D(width, height)
	ProcUtil.AsteroidalBombardment(heightMap, width, height, 20, 150, 200, 0.2, 0.4, 0.5)
	ProcUtil.AsteroidalBombardment(heightMap, width, height, 80, 25, 100, 0.2, 0.4, 0.5)
	ProcUtil.AsteroidalBombardment(heightMap, width, height, 300, 5, 50, 0.1, 0.2, 0.5)
	ProcUtil.AsteroidalBombardment(heightMap, width, height, 1000, 1, 10, 0.02, 0.1, 0.5)
	#update()
	...
	for x in range(width):
		for y in range(height):
			...
			elif(heightMap[x][y] <= 0.55):
				col = Color(0.2, 0.2, 1.0)
			elif(heightMap[x][y] <= 0.6):
				col = Color(0.4, 0.4, 1.0)
			elif(heightMap[x][y] <= 0.62):
				col = Color(0.76, 0.70, 0.50)
			elif(heightMap[x][y] <= 0.72):
				col = Color(0.49, 0.99, 0)
			elif(heightMap[x][y] <= 0.85):
				col = Color(0, 0.50, 0)
			elif(heightMap[x][y] <= 0.9):
			...
			#img.put_pixel(x, y, Color(heightMap[x][y] if heightMap[x][y] > 0 else 0, 0, 0))
...
func Erode():
	ProcUtil.HydraulicErosion(heightMap, width, height, 1, 0.8, 0.5, 0.5, 0.8)
	print(heightMap[0][0])
	var img = Image(width, height, true, Image.FORMAT_RGB)
	for x in range(width):
		for y in range(height):
...
#				elif(heightMap[x][y] <= 0.62):
#					col = Color(0.76, 0.70, 0.50)
#				elif(heightMap[x][y] <= 0.68):
#					col = Color(0.49, 0.99, 0)
#				elif(heightMap[x][y] <= 0.75):
#					col = Color(0, 0.50, 0)
#				elif(heightMap[x][y] <= 0.82):
#					col = Color(0.54, 0.27, 0.07)
#				elif(heightMap[x][y] <= 0.95):
#					col = Color(0.66, 0.66, 0.66)
#				else:
